...
# TODO: replace arn:aws:kms:us-east-1:xxxx:key/7a8ea545-e379-4ac5-8903-3f5ae22ea847 with your KMS key id arn!
...
#         "kms:RevokeGrant"
#       ],
#       "Resource": ["arn:aws:kms:us-east-1:xxxx:key/7a8ea545-e379-4ac5-8903-3f5ae22ea847"],
#       "Condition": {
#         "Bool": {
